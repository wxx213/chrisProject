 ...
 */
package com.mydeo.seckilldemo.util;
...
public class ToolUtil {
    ...
    public static String getRandomString(int length) {
        String base = "ABCDEFGHIJKLMNOPQRESTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
...
//	}
     ...
     * @return
     */
    public static Map<String, Object> successfulMap(String msg){
     ...
     * @return
     */
    public static Map<String,Object> customParam(String key,Object value){
        Map<String ,Object> map = new HashMap<>();
        map.put(key, value);
        return map;
    }
